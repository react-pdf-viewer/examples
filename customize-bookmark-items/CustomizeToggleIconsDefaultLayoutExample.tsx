...
interface CustomizeToggleIconsDefaultLayoutExampleProps {
    fileUrl: string;
}
...
const CustomizeToggleIconsDefaultLayoutExample: React.FC<CustomizeToggleIconsDefaultLayoutExampleProps> = ({
    fileUrl,
}) => {
...
export default CustomizeToggleIconsDefaultLayoutExample;
