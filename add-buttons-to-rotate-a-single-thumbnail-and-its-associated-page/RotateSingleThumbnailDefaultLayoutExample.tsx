...
interface RotateSingleThumbnailDefaultLayoutExampleProps {
    fileUrl: string;
}

const RotateSingleThumbnailDefaultLayoutExample: React.FC<RotateSingleThumbnailDefaultLayoutExampleProps> = ({
    fileUrl,
}) => {
    ...
    return <Viewer defaultScale={0.5} fileUrl={fileUrl} plugins={[defaultLayoutPluginInstance]} />;
};

export default RotateSingleThumbnailDefaultLayoutExample;
