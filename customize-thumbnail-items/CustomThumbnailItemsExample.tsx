...
const CustomThumbnailItemsExample: React.FC<CustomThumbnailItemsExampleProps> = ({ fileUrl }) => {
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Viewer onDocumentLoad={handleDocumentLoad} fileUrl={fileUrl} plugins={[thumbnailPluginInstance]} />
                </div>
            </div>
        </div>
    );
...
export default CustomThumbnailItemsExample;
