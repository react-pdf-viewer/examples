...
interface CustomThumbnailItemsDefaultLayoutExampleProps {
    fileUrl: string;
}

const CustomThumbnailItemsDefaultLayoutExample: React.FC<CustomThumbnailItemsDefaultLayoutExampleProps> = ({
    fileUrl,
}) => {
    ...
    return (
        ...
        >
            ...
            >
                <Viewer onDocumentLoad={handleDocumentLoad} fileUrl={fileUrl} plugins={[defaultLayoutPluginInstance]} />
            </div>
        </div>
    );
};

export default CustomThumbnailItemsDefaultLayoutExample;
